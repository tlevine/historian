...
def test_read_session():
 ...
 #  w = csv.writer(open(os.path.join('historian_reader', 'test', 'fixtures', '2014-08-23 02:27:05.033008250+00:00'), 'w'))
 #  for a,b in observed:
 #      w.writerow((a.timestamp(), b))
    ...
    with open(os.path.join('historian_reader', 'test', 'fixtures', '2014-08-23 02:27:05.033008250+00:00.csv')) as fp:
        expected = [(int(a),datetime.datetime.fromtimestamp(int(b))) \
